...
class stop_node; 
class while_node; 
class memallocation_node; 
class sweep_node; 
class fundeclaration_node; 
class vardeclaration_node; 
...
#include "ast/memallocation_node.h"
#include "ast/sweep_node.h"
#include "ast/fundeclaration_node.h"
#include "ast/vardeclaration_node.h"
