...
void xpl::postfix_writer::do_fundeclaration_node(xpl::fundeclaration_node * const node, int lvl){}
...
void xpl::postfix_writer::do_memallocation_node(xpl::memallocation_node * const node, int lvl){}
//---------------------------------------------------------------------------
